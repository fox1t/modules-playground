...
const cjs_triplet_1 = __importDefault(require("cjs-triplet"));
const HelloWorldStar = __importStar(require("cjs-triplet"));
...
if (HelloWorldStar.helloWorld() !== 'Hello World')
    throw new Error('Oh no!');
const cjs_triplet_2 = __importDefault(require("cjs-triplet"));
if ((0, cjs_triplet_2.default)() !== 'Hello World')
    throw new Error('Oh no!');
const cjs_triplet_3 = require("cjs-triplet");
if ((0, cjs_triplet_3.helloWorld)() !== 'Hello World')
    throw new Error('Oh no!');
Promise.resolve().then(() => __importStar(require('cjs-triplet'))).then(helloWorld => {
